...
static const char *sndctrlcmd[]  = { "x-terminal-emulator", "-e", "alsamixer" };
static const char *termcmd[]     = { "x-terminal-emulator", "-bg", "black", "-fg", "white" };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_s,      spawn,          {.v = sndctrlcmd } },
